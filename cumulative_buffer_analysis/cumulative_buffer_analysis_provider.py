...
from .cumulative_buffer_analysis_algorithm import CumulativeBufferAnalysisAlgorithm


class CumulativeBufferAnalysisProvider(QgsProcessingProvider):
    ...
    def loadAlgorithms(self):
        ...
        """
        self.addAlgorithm(CumulativeBufferAnalysisAlgorithm())
    ...
    def name(self):
        ...
        """
        return self.tr('Cumulative Buffer Analysis')
