...
from .cumulative_buffer_analysis_provider import CumulativeBufferAnalysisProvider
...
class CumulativeBufferAnalysisPlugin(object):
    ...
    def initProcessing(self):
        ...
        self.provider = CumulativeBufferAnalysisProvider()
